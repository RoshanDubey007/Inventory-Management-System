...
class FormMenu:
    ...
    def __init__(self,master):
        self.frame=master
        #self.frame.title="Shop Pro using Python & Tkinter by Roshan Dubey"
    ...
    def _init_menu(self):
        ...
        filemenu.add_command(label="Product Viewing", command=self.products_click)
        filemenu.add_command(label="Invoice History", command=self.invoices_click)
        filemenu.add_command(label="Create Invoices", command=self.addinvoice_click)
    ...
    def about_click(self):
        w=Toplevel()
        lbl1=Label(w,text="Welcome to Inventory Management System")
        lbl1.pack(side="top",padx=10,pady=10)
        lbl3=Label(w,text="for help contact me at:Roshandubey07@gmail.com")
        lbl3.pack(side="top",padx=10,pady=10)
        lbl3=Label(w,text="12133")
        lbl3.pack(side="top",padx=10,pady=10)
